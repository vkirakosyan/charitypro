            ...
            <div class="col-md-9">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <form method="POST" action="{{url('admin/stories', $stories->id)}}" class="form-horizontal" enctype="multipart/form-data">
                            @include ('admin.stories.form', ['submitButtonText' => 'Update'])
