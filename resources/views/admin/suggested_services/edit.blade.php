            ...
            <div class="col-md-9">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        @endif
                        <form method="POST" action="{{url('admin/suggested_services', $service->id)}}" class="form-horizontal" enctype="multipart/form-data">
                            @include ('admin.suggested_services.form', ['submitButtonText' => 'Update'])
