            ...
            <div class="col-md-9">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <form method="POST" action="{{url('admin/what_they_say', $whattheysay->id)}}" class="form-horizontal" enctype="multipart/form-data">
                            @include ('admin.what_they_say.form', ['submitButtonText' => 'Update'])
